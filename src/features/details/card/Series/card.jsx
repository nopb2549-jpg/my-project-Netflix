export default function Card (){
    return(
        <div className="">
            ...
            {/* ส่วนปิด */}
            {/* bg-gray-600 w-full h-24 flex justify-center items-end --overflow-hidden  */}
            <div className="flex justify-center items-end p-4 -mt-6 relative text-white bg-linear-to-t from-[#181818]/50 to-transparent backdrop-blur-sm shadow-black/10 border-b-1">
                <div className="p-2 absolute -bottom-5.5 boder border-e-gray-50 border-solid border rounded-4xl">
